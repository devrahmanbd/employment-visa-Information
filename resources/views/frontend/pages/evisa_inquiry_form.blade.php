    ...
    <div class="card w-full h-screen max-w-md mx-auto min-h-[450px] bg-white shadow-lg">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('web-app-evisa-details') }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        <label for="visa_number" class="text-xs text-gray-500">Visa Number</label>
                        <input type="text" name="visa_number" id="visa_number"
                            class="w-full p-2 border border-gray-300 rounded-lg" required>
                    </div>

                    <div>
                        <label for="mio_reference" class="text-xs text-gray-500">MIO Reference</label>
                        <input type="text" name="mio_reference" id="mio_reference"
                            class="w-full p-2 border border-gray-300 rounded-lg" required>
                    </div>

                    <div>
                        <label for="passport_number" class="text-xs text-gray-500">Passport Number</label>
                        <input type="text" name="passport_number" id="passport_number"
                            class="w-full p-2 border border-gray-300 rounded-lg" required>
                    </div>

                    <div>
                        <button type="submit" class="w-full py-2 rounded-lg btn-submit">Submit</button>
                    </div>
                </div>
            </form>
        </div>
