...
@section('content')
    ...
    <p>The webpage of Public Authority of Manpower is authorized and fully controlled by the Ministry of Interior [<a
            href="https://www.moi.gov.kw">https://www.moi.gov.kw</a>] (MOI), State of Kuwait and Ministry of Foreign Affairs
    ...
    <p>This is an online service provided by the Ministry of Interior [<a
        ...
        procedures needed to recruit employees for business owners, and managing all the transactions online. This service
        allows you to:</p>
